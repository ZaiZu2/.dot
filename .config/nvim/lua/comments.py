...
# Simple comment
#Another comment with no space after the hash

#    Comment with leading spaces before the hash

#Comment with tabs before the hash
	#Comment with a tab character at the beginning

# Comment with multiple spaces after the hash
...
# Comment block with wrapping:
# This is an example of a longer comment
# that spans multiple lines and wraps nicely,
# resembling formatted text in a document.
